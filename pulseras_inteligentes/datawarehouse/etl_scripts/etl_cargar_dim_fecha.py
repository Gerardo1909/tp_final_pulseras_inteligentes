"""
Script ETL para cargar la dimensión de fecha en el Data Warehouse.

Este script genera un rango de fechas para un período específico y las inserta
en la tabla de dimensión de fechas del Data Warehouse, incluyendo atributos
...
def main():
    ...
    """
    nombre_etl = "ETL_CARGAR_DIM_FECHA"
    ...
    with manejo_errores_etl(nombre_etl):
        ...
        try:
            ...
            # Resumen final
            logger.info(f"{nombre_etl}: Proceso completado con éxito. {total_insertadas} de {len(fechas)} fechas insertadas.")
