"""
Script ETL para generar e insertar datos simulados de uso de la aplicación en MongoDB.
...
def main():
    ...
    """
    nombre_etl = "ETL_INSERTAR_REGISTROS_APLICACION"
    ...
    with manejo_errores_etl(nombre_etl):
        ...
        try:
            ...
            logger.info(f"{nombre_etl}: Proceso completado con éxito. {total_registros} registros generados en total.")
        finally:
            # Cierre de conexión
